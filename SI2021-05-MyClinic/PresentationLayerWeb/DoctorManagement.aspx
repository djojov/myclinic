                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item active">
                        <asp:HyperLink CssClass="nav-link" ID="HyperLink2" runat="server" NavigateUrl="~/DoctorManagement.aspx">Doctor management<span class="sr-only">(current)</span></asp:HyperLink>
                      </li>
                        <li class="nav-item">
