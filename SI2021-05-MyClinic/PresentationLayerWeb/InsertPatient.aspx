        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="form-group row">
                    ...
                    <small class="form-text text-danger"><asp:RegularExpressionValidator ID="RegularExpressionValidator_PlaceOfBirth" runat="server" ErrorMessage="Place of birth entered incorrectly!" Text="Place of birth entered incorrectly!" ControlToValidate="TextBox_PlaceOfBirth" ValidationExpression="^[A-Z]+[A-Za-z\s]{1,20}([A-Z]?)+([A-Za-z\s]?)$"></asp:RegularExpressionValidator></small>
                </div>
                <div class="form-group row">
